...
<p>Given an integer array <code>nums</code> representing the amount of money of each house, return <b>the maximum amount of money you can rob tonight without alerting the police.</b></p>
